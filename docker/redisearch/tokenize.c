...
//      escaped = 1;
//      continue;
//    } else if (s[ii] == '\xc4' && (ii + 1) < origLen && (s[ii + 1] == '\x85' || s[ii + 1] == '\x84')) {
//      SWITCH_DEST();
//      realDest[dstLen++] = 'a';
//      ++ii;
//    } else if (s[ii] == '\xc5' && (ii + 1) < origLen && (s[ii + 1] == '\xbc' || s[ii + 1] == '\xbb')) {
//      SWITCH_DEST();
//      realDest[dstLen++] = 'z';
//      ++ii;
//    } else {
...
//  }
  ...
  for (size_t ii = 0; ii < origLen; ++ii) {
    if (isupper(s[ii])) {
      ...
      escaped = 1;
      continue;
    } else if (s[ii] == '\xc3' && (ii + 1) < origLen && (s[ii + 1] == '\xb3' || s[ii + 1] == '\x93')) { // ó or Ó
      SWITCH_DEST();
      realDest[dstLen++] = 'o';
      ++ii;
    } else if (s[ii] == '\xc4' && (ii + 1) < origLen) {
      if (s[ii + 1] == '\x85' || s[ii + 1] == '\x84') { // ą or Ą
        SWITCH_DEST();
        realDest[dstLen++] = 'a';
        ++ii;
      } else if (s[ii + 1] == '\x87' || s[ii + 1] == '\x86') { // ć or Ć
        SWITCH_DEST();
        realDest[dstLen++] = 'c';
        ++ii;
      } else if (s[ii + 1] == '\x99' || s[ii + 1] == '\x98') { // ę or Ę
        SWITCH_DEST();
        realDest[dstLen++] = 'e';
        ++ii;
      }
    } else if (s[ii] == '\xc5' && (ii + 1) < origLen) {
      if (s[ii + 1] == '\xbc' || s[ii + 1] == '\xbb') { // ż or Ż
        SWITCH_DEST();
        realDest[dstLen++] = 'z';
        ++ii;
      } else if (s[ii + 1] == '\x82' || s[ii + 1] == '\x81') { // ł or Ł
        SWITCH_DEST();
        realDest[dstLen++] = 'l';
        ++ii;
      } else if (s[ii + 1] == '\x84' || s[ii + 1] == '\x83') { // ń or Ń
        SWITCH_DEST();
        realDest[dstLen++] = 'n';
        ++ii;
      } else if (s[ii + 1] == '\x9a' || s[ii + 1] == '\x9b') { // ś or Ś
        SWITCH_DEST();
        realDest[dstLen++] = 's';
        ++ii;
      } else if (s[ii + 1] == '\xb9' || s[ii + 1] == '\xba') { // Ź or ź
        SWITCH_DEST();
        realDest[dstLen++] = 'z';
        ++ii;
      }
